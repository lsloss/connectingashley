<?php
/**
 * Custom connectingashley comments
 *
 * @package connectingashley
 */

/**
 * Connecting Ashley Theme comments
 *
 ...
 */
function connectingashley_comments( $comment, $args, $depth ) {
...
add_filter( 'edit_comment_link', 'connectingashley_edit_comment_link' );
 ...
 */
function connectingashley_edit_comment_link( $output ) {
	return str_replace( 'comment-edit-link', 'comment-edit-link _comments__edit-link', $output );
}

add_filter( 'comment_reply_link', 'connectingashley_comment_reply_link' );
 ...
 * @param string $output Accepts output string.
 */
function connectingashley_comment_reply_link( $output ) {
