export const categoryConfig = {
    CommunityHubsAndProjects: { baseColor: '#ffe600', symbol: 'CommunityHubsAndProjects' },
    EcoProjects: { baseColor: '#5e9edd', symbol: 'EcoProjects' },
    Facility: { baseColor: '#17377b', symbol: 'Facility' },
